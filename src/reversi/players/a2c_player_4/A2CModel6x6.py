...
class A2CModel:
    ...
    def __init__(self,
        ...
        with tf.name_scope('model'):
            ...
            flat_layer = tf.keras.layers.Flatten()(cnn_1)
            ...
            # dense_shared_2 = self._create_dense_layer(64)(dense_shared_1)
            ...
            short_cut = \
                tf.keras.layers.concatenate([X_normal_flat, dense_shared_1])
            ...
            value_fn = self._create_dense_layer(1, act_fn=None)(value_dense_1)
